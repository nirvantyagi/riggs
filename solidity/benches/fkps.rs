...
fn main() {
    ...
    let zeros = &[0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x00];
    ...
    let result = evm.call(contract.encode_call_contract_bytes("testVerOpen", &input).unwrap(), &contract_addr, &deployer).unwrap();
